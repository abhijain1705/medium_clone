...
const BlogSection = () => {
  const styles = {
    BlogSectionWrapper:
      "flex h-[100vh] px-28 flex-col w-[100%] lg:w-[65%] border border-[#E6E6E6] border-t-0 border-l-0 border-r-1 border-b-0",
    BlogSectionInnerWrapper: "xl:w-[85%] mx-auto h-[100%] flex flex-col",
    BlogSectionChild_1: "mt-4",
    HorizontalLine: "mt-4 w-[600px]",
    BlogSectionChild_1InnerWrapper: "flex gap-2 items-center text-[13px]",
    BlogSectionChild_2: "flex items-center justify-between mt-8",
    BlogSectionChild_2Profile: 'flex items-center justify-center gap-2',
    BlogSectionChild_2Name: 'font-medium text-[14px]',
    BlogSectionChild_2ProfileName: 'flex flex-col',
    BlogSectionChild_2BlogSummary: 'flex items-center gap-5 text-[10px] text-[#757575]',
    BlogSectionChild_2IconsWrapper: 'flex items-center gap-2',
    BlogSectionChild_2Icon: 'w-[20px] fill-[#A8A8A8] h-[20px] hover:fill-black cursor-pointer'
  };
      ...
      <div className={styles.BlogSectionInnerWrapper}>
        <div className={styles.BlogSectionChild_1}>
          <div className={styles.BlogSectionChild_1InnerWrapper}>
            ...
            />
            <div>Published in The Startup</div>
          </div>
        ...
        <div className={styles.BlogSectionChild_2}>
          ...
          <div className={styles.BlogSectionChild_2IconsWrapper}>
            <svg className={styles.BlogSectionChild_2Icon} width="24" height="24" viewBox="0 0 24 24" fill="none">
              <path
            ...
            <svg className={`${styles.BlogSectionChild_2Icon} ml-4`}
              width="24"
              height="24"
              viewBox="0 0 24 24"
            // fill="none"
            ...
            <svg className={`${styles.BlogSectionChild_2Icon} ml-4`} width="24" height="24" viewBox="0 0 24 24" fill="none">
              <path
                fillRule="evenodd"
                clipRule="evenodd"
